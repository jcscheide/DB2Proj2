...
public class BTreeDir {
	 ...
	 * examined. A non-null return value indicates that the child node split,
	 * and so the returned entry is inserted into this block. If this block
	 * splits, then the method similarly returns the entry information of the
	 * new block to its caller; otherwise, the method returns null.
	 * 
	 * @param e
