...
public interface AggregationFn {
	...
	/**
	 * Uses the current record of the specified scan to be the first record in
	 * the group.
	 * 
	 * @param s
	 *            the scan to aggregate over.
	 */
	void processFirst(Scan s);

	/**
	 * Uses the current record of the specified scan to be the next record in
	 * the group.
	 * 
	 * @param s
	 *            the scan to aggregate over.
