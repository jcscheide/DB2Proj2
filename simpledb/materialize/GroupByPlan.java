...
public class GroupByPlan implements Plan {
	...
	/**
	 * Creates a groupby plan for the underlying query. The grouping is
	 ...
	 * is one pass through the sorted table. It does <i>not</i> include the
	...
	/**
	 * Returns the number of groups. Assuming equal distribution, this is the
	 * product of the distinct values for each grouping field.
	 * 
	...
	/**
	 * Returns the number of distinct values for the specified field. If the
	 * field is a grouping field, then the number of distinct values is the same
	 * as in the underlying query. If the field is an aggregate field, then we
