...
public class MaterializePlan implements Plan {
	 ...
	 * <i>not</i> include the one-time cost of materializing the records.
	 * 
	...
	/**
	 * Returns the number of records in the materialized table, which is the
	 * same as in the underlying plan.
	 * 
	...
	/**
	 * Returns the number of distinct field values, which is the same as in the
	 * underlying plan.
	 * 
