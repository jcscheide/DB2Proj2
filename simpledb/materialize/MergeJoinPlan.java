...
public class MergeJoinPlan implements Plan {
	 ...
	 * materialized sorted tables. It does <i>not</i> include the one-time cost
	...
	/**
	 * Returns the number of records in the join. Assuming uniform distribution,
	 * the formula is:
	 * 
	 * <pre>
	...
	/**
	 * Estimates the distinct number of field values in the join. Since the join
	 * does not increase or decrease field values, the estimate is the same as
	 * in the appropriate underlying query.
	 * 
