...
class TablePlanner {
	...
	/**
	 * Constructs a join plan of the specified plan and the table. The plan will
	 * use an indexjoin, if possible. (Which means that if an indexselect is
	 * also possible, the indexjoin operator takes precedence.) The method
