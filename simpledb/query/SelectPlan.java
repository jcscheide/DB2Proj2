...
/**
 * The Plan class corresponding to the <i>select</i> relational algebra
 * operator.
 * 
...
public class SelectPlan implements Plan {
	...
	/**
	 * Estimates the number of block accesses in the selection, which is the
	...
	/**
	 * Estimates the number of output records in the selection, which is
	...
	/**
	 * Estimates the number of distinct field values in the projection. If the
	 * predicate contains a term equating the specified field to a constant,
	 * then this value will be 1. Otherwise, it will be the number of the
	 * distinct values in the underlying query (but not more than the size of
	 * the output table).
	 * 
