...
public interface Expression {
	 ...
	 * exception if the expression does not denote a constant.
	 * 
	...
	/**
	 * Returns the field name corresponding to a constant expression. Throws an
	 * exception if the expression does not denote a field.
	 * 
	...
	/**
	 * Evaluates the expression with respect to the current record of the
	 * specified scan.
	 * 
	 * @param s
	 *            the scan
