...
public class RemoteMetaDataImpl extends UnicastRemoteObject implements RemoteMetaData {
	 ...
	 * column. For a string-type field, the method simply looks up the field's
	 * length in the schema and returns that. For an int-type field, the method
	 * needs to decide how large integers can be. Here, the method arbitrarily
	 * chooses 6 characters, which means that integers over 999,999 will
