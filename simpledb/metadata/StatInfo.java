...
/**
 * Holds three pieces of statistical information about a table: the number of
 * blocks, the number of records, and the number of distinct values for each
 * field.
 * 
...
public class StatInfo {
	...
	/**
	 * Creates a StatInfo object. Note that the number of distinct values is not
